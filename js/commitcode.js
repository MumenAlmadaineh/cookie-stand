...
function tableBottom() {
  ...
  for(let i = 0; i < workingHours.length; i++){
    ...
    // console.log(totalColom);
    mArr.push(totalColom);
  }
  let a = totalOfCookiesArray;
  let total = a.reduce(function(accumulator, currentValue) { return accumulator + currentValue; }, 0);
  console.log(total);

  let theLastElement = document.createElement('th');
  trBottomlement.appendChild(theLastElement);
  theLastElement.textContent = total;
...
// console.log(totalOfCookiesArray);
...
// console.log(mArr);
// console.log(mArr.push(total));

// let b = mArr;
// let total1 = b.reduce(function(accumulator, currentValue) { return accumulator + currentValue; }, 0);
// console.log(total1);
...
// console.log(totalOfCookiesArray[0]);
